...
public enum MegaWallsClass {
    ...
    AUTOMATON("ATN", "Automaton", "A-23 Protocol", 3, 12.0D, 4, 4, DiamondGear.LEGGINGS, DiamondGear.BOOTS),
    ...
    MOLEMAN("MOL", "Moleman", "Dig", 2, 16.0D, 10, 10, DiamondGear.SHOVEL, DiamondGear.LEGGINGS),
